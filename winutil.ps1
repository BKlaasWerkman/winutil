...
$sync.configs.applications = '{
  ...
  "WPFInstallveracrypt": {
    ...
    "choco": "filezilla",
    "content": "FileZilla",
    "description": "FileZilla - The free FTP solution",
...
<StackPanel Orientation="Horizontal">
<CheckBox Name="WPFInstallveracrypt" Content="FileZilla" ToolTip="FileZilla - The free FTP solution" Margin="0,0,2,0"/><TextBlock Name="WPFInstallveracryptLink" Style="{StaticResource HoverTextBlockStyle}" Text="(?)" ToolTip="https://filezilla-project.org" />
</StackPanel>
<StackPanel Orientation="Horizontal">
